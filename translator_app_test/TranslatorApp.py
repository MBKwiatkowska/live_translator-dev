...
from . import transcription_queue
...
class TranscriptionApp:
    ...
    def __init__(self, root):
        ...
        self.logo_label.pack(side='top', pady=0)
        ...
        self.previous_label.pack(pady=10, side='bottom')
        ...
        self.current_label.pack(pady=10, side='top',)
